...
############start slot loop
  if input.downcase == "slots"
    loop do
      ...
      break if (continue_slots.downcase == "no")
    end
##########end slot loop
...
##########Begin black jack loop
    ...
    loop do
      ...
      loop do
        ...
        break if (answer.downcase != "yes") || (numbers > 21)
      end
      ...
      break if (continue_black.downcase == "no")
    end
  end
...
#############End main loop
1 Comment Collapse
Here you go!  All finnished and ready for more fun!
...
Shane Soderstrom [9:26 AM]  
added and commented on this Ruby snippet 
###########Begin Wallet Class
class Wallet
  @@default_wallet = 100
